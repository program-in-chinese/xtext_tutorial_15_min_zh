...
// Entry rule entryRuleQuan6
entryRuleQuan6 returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getQuan6Rule()); }
	iv_ruleQuan6=ruleQuan6
	{ $current=$iv_ruleQuan6.current; }
	EOF;

// Rule Quan6
ruleQuan6 returns [EObject current=null]
@init {
	enterRule();
}
@after {
