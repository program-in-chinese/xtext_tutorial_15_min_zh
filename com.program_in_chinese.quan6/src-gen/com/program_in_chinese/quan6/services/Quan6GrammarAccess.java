 ...
 */
package com.program_in_chinese.quan6.services;
...
@Singleton
public class Quan6GrammarAccess extends AbstractGrammarElementFinder {
	
	public class Quan6Elements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.program_in_chinese.quan6.Quan6.Quan6");
	...
	public class AbstractElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.program_in_chinese.quan6.Quan6.AbstractElement");
	...
	public class FeatureElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.program_in_chinese.quan6.Quan6.Feature");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class PropertyElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "com.program_in_chinese.quan6.Quan6.Property");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	@Inject
	public Quan6GrammarAccess(GrammarProvider grammarProvider,
			XbaseGrammarAccess gaXbase,
			XtypeGrammarAccess gaXtype) {
		this.grammar = internalFindGrammar(grammarProvider);
		this.gaXbase = gaXbase;
		this.gaXtype = gaXtype;
		this.pQuan6 = new Quan6Elements();
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("com.program_in_chinese.quan6.Quan6".equals(grammar.getName())) {
				return grammar;
			}
	...
	//	importSection=XImportSection?
	//	elements+=AbstractElement*;
	public Quan6Elements getQuan6Access() {
		return pQuan6;
	}
	
	public ParserRule getQuan6Rule() {
		return getQuan6Access().getRule();
	}
